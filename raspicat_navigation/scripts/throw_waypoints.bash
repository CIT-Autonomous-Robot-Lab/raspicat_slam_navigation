...
yaml_file="$HOME/mugimaru-docker/ros2_ws/src/raspicat_slam_navigation/raspicat_navigation/config/waypoint/wp_kakuninn.yaml" # 追加分のwaypointのyamlのパス
...
#ros2 action send_goal /follow_waypoints nav2_msgs/action/FollowWaypoints pose_array
echo $pose_array
